...
class BagRulesTest {
    ...
    internal fun testConstructor() {
        val bagRules = BagRules("src/test/resources/day7/puzzle1/test_input1.txt")
    ...
    internal fun testHowManyBagsMustContain() {
        var bagRules = BagRules("src/test/resources/day7/puzzle1/test_input1.txt")
    ...
    internal fun testHowManyBagsMustContain2() {
        var bagRules = BagRules("src/test/resources/day7/puzzle1/test_input2.txt")
